...
standard_loader_message = dmc.Loader(html.Div("Data is currently loading..."))
...
def update_overview_content(chip_medicine, chip_physics, chip_chemistry, chip_economics, chip_literature, chip_peace, timerange):
    ...
    number_of_laureates, number_of_prizes, laureate_oldest_name, laureate_oldest_age, laureate_youngest_name, laureate_youngest_age, df_filtered_laureates = pcp.generate_overview_stats(selected_categories)
