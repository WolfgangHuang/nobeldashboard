...
df_sunburst_gender_nationality = df_laureates[df_laureates['Prize0_AwardYear'] == 2024]
...
df_movement_splines_2024 = df_movement_splines[df_movement_splines["Prize0_AwardYear"] == 2024]
...
def generate_map_splines(data):
    ...
    fig.update_layout(
        ...
        title=dict(
            text = "Place of Birth and Affiliation at Time of Award",
            font=dict(size = 20),
            x = 0,                            # Left align the title
            xanchor = 'left',                 # Align to the left edge
            y = 0.97,                         # Adjust Y to position title above the map
